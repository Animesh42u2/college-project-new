    ...
    <div className="md:mx-10 ">
      <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm ">
        ...
        <div>
          ...
          <p className="w-full md:w-2/3  text-gray-600 leading-6  ">
            KIMS is on a mission to make quality healthcare affordable and
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-gray-600">
            <li>+91 9170019029</li>
            <li>+91 7735743584  </li>
            ANKITSINGH1757@GMAIL.COM
            MOHAPATRAANIMESH69@GMAIL.COM
          </ul>
        </div>
      </div>
      {/* copyright part */}
      <div>
        ...
        <p className="py-5 text-sm text-center text-gray-800">
          Copyright 2025 @ ANIMESH MOHAPATRA && ANKIT SINGH - All Right Reserved.
        </p>
      </div>
    </div>
  );
